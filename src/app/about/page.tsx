...
export const metadata: Metadata = {
  ...
  description:
    "Discover the philosophy, mission, and vision of NBU Business School. Learn about our world-class British academic standards and executive leadership in Nigeria.",
  keywords: [
    "NBU Philosophy",
    "Business School Governance",
    "Academic Excellence",
    "British University Nigeria",
    "Leadership",
    "Mentorship",
  ],
};
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mb-20">
            ...
            <h3 className="text-4xl md:text-5xl font-black text-slate-950 mb-8 uppercase leading-[1.1]">
              The Philosophy of <br />
              Nigerian British University
            </h3>
            <p className="text-lg text-slate-800 leading-relaxed font-medium">
              Based on its core values, our philosophy aims to inspire
              self-motivation and excellence as a prerequisite for building an
            ...
            {[
              {
                icon: ScrollText,
                label: "Mentorship",
                desc: "Inspiring self-motivation through guidance.",
              },
              {
                icon: Zap,
                label: "Dynamism",
                desc: "Constant academic and professional evolution.",
              },
              {
                icon: Shield,
                label: "Integrity",
                desc: "Upholding professional and ethical standards.",
              },
              {
                icon: Scale,
                label: "Equity",
                desc: "Constructed on fairness and equal access.",
              },
              {
                icon: HeartHandshake,
                label: "Diversity",
                desc: "Celebrating multi-faceted perspectives.",
              },
            ].map((val, i) => (
              <div
                key={i}
                className="bg-slate-50 p-10 hover:bg-white hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 group border-b-4 border-transparent hover:border-primary"
              >
                <val.icon className="w-10 h-10 text-primary mb-6 transition-transform group-hover:scale-110" />
                <h4 className="font-extrabold uppercase text-xs tracking-widest mb-4">
                  {val.label}
                </h4>
      ...
      <section className="py-32 bg-slate-950 text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-32">
            {/* University Level */}
            <div>
              <div className="inline-block px-4 py-1 border border-primary/30 text-primary text-[10px] font-black uppercase tracking-widest mb-8">
                University Level
              </div>
              <h3 className="text-3xl font-black mb-16 uppercase tracking-tight leading-none">
              ...
              <div className="space-y-16">
                <div>
                  ...
                  <p className="text-slate-200 text-lg leading-relaxed font-medium pl-9 border-l border-white/5">
                    To be a world-class British University in Nigeria, anchored
                    on academic excellence and distinguished by a robust
                    interface between research and industry.
                  </p>
                </div>
                <div>
                  ...
                  <p className="text-slate-200 text-lg leading-relaxed font-medium pl-9 border-l border-white/5">
                    To develop globally competitive graduates by offering
                    proactive and distinctive research opportunities, a learning
                    and professional mentoring environment with adequate
            ...
            <div>
              ...
              <div className="space-y-16">
                <div>
                  ...
                  <p className="text-slate-200 text-lg leading-relaxed font-medium pl-9 border-l border-white/5">
                    To be a globally recognized business school, fostering
                    innovative leaders who transform businesses and ethical
                    practices for the betterment of the society.
                  </p>
                </div>
                <div>
                  <div className="flex items-center gap-4 mb-4">
                  ...
                  <p className="text-slate-200 text-lg leading-relaxed font-medium pl-9 border-l border-white/5">
                    Our mission is to provide world-class business education and
                    research that empowers students, supports economic
                    development, and engages with communities to promote
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-start mb-20 gap-10">
            ...
            <p className="text-slate-700 max-w-lg font-medium">
              ...
              students through quality teaching, research and practical learning
              in order to enhance productivity, wealth maximization and social
              responsiveness.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="group p-8 border-2 border-slate-50 hover:border-primary/20 transition-all duration-300 flex items-start gap-6"
              >
                <span className="text-2xl font-black text-slate-400 group-hover:text-primary transition-colors uppercase italic font-serif leading-none mt-1">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
            <div>
              ...
              <h3 className="text-4xl font-black text-slate-950 mb-10 uppercase tracking-tight">
                Academic <br />
                Methodology
              </h3>
              <div className="space-y-6 text-slate-800 text-lg leading-relaxed font-medium">
                <p>
                  NBU Business School that offers a wide range of professional
                  and academic programmes. The academics are characterized by a
                  combination of rigorous coursework, practical teaching and
                  research, experiential learning opportunities, and
                  collaboration with faculty and industry professionals.
                </p>
                <p>
                  We prioritize an interdisciplinary and global approach,
                  preparing students for the rapidly evolving global business
                  environment. Our school coordinates courses across Faculties,
                  relevant for the award of postgraduate degrees, Diplomas, and
                  Certificates.
                </p>
              </div>

              <div className="mt-16 bg-white p-12 border-l-4 border-primary shadow-xl">
                <h5 className="font-black text-slate-950 text-sm tracking-widest uppercase mb-4">
                  Strategic Mandate
                </h5>
                <p className="text-slate-700 font-medium italic">
                  "Responsible for the coordination of NBU's Strategic Foreign
                  Collaboration, Partnerships and Affiliations."
                </p>
              </div>
            </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-24">
            <h2 className="text-4xl md:text-5xl font-black text-slate-950 uppercase mb-8">
              Governance <span className="text-primary">&</span> Leadership
            </h2>
            <div className="w-24 h-1 bg-primary mx-auto mb-10" />
            <p className="text-slate-700 font-medium">
              The Business School is governed by the NBU Business School Board,
              ensuring rigorous academic standards and strategic industry
              alignment.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="bg-slate-50 p-12 border border-slate-100">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div
                    key={i}
                    className="flex gap-4 items-start pb-6 border-b border-slate-200 last:border-0 group"
                  >
            ...
            <div className="space-y-12">
              <div>
                <h4 className="text-xs font-black uppercase tracking-[0.3em] text-slate-500 mb-8 border-b border-gray-100 pb-4">
                  Principal Board Membership
                </h4>
                <ul className="space-y-4">
                  <li className="flex justify-between items-center text-sm font-bold uppercase tracking-widest text-slate-900 border-b border-gray-50 pb-3">
                    <span>Dean of Business School</span>{" "}
                    <span className="text-primary">Chairman</span>
                  </li>
                  <li className="flex justify-between items-center text-sm font-bold text-slate-600 border-b border-gray-50 pb-3">
              ...
              <div className="bg-slate-950 p-10 text-white relative">
                ...
                <p className="text-slate-200 text-sm leading-relaxed mb-6 font-medium">
                  Serves as the Clearing House for matters relating to academic
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <p className="text-slate-800 text-lg leading-relaxed font-medium mb-10">
                Our strategies maximally leverage platforms such as Facebook,
                LinkedIn, Instagram, and YouTube. We target associations and
                industry hubs using personal contacts and clear, consistent
                messaging.
              </p>
              <div className="flex gap-4">
                <div className="w-10 h-10 rounded-full bg-white border border-gray-200 flex items-center justify-center text-slate-400">
            ...
            <div className="bg-[#E62627] p-12 text-white shadow-2xl skew-y-1">
              <div className="-skew-y-1">
                ...
                <p className="text-white/80 font-bold mb-10 leading-relaxed">
                  ...
                  the skills-gaps and practical knowledge needs of the
                  contemporary industry landscape.
                </p>
                <a
                  href="/programs"
                  className="px-8 py-4 bg-blue-600 text-primary font-black uppercase tracking-widest text-xs hover:bg-slate-900 hover:text-white transition-all"
                >
                  Explore Directory
                </a>
              </div>
