...
export const metadata: Metadata = {
  ...
  description:
    "Browse our directory of 34+ Senate-approved professional diploma programs. Specialized training in Finance, Technology, Governance, and Management in Nigeria.",
  keywords: [
      ...
      <div className="bg-slate-900 py-24 text-white">
        <div className="container mx-auto px-4">
          ...
          <p className="text-slate-300 text-xl max-w-2xl leading-relaxed">
            ...
            Diploma programmes designed for the next generation of global
            leaders.
          </p>
        </div>
      </div>
