...
export const metadata: Metadata = {
  ...
  description:
    "Learn about the simplified admission process, entry requirements, and payment details for NBU Business School. Join our professional diploma programs today.",
  keywords: [
    "NBU Admission",
    "Apply to Business School Nigeria",
    "Professional Diploma Requirements",
    "Business School Fees",
    "Executive Education Admission",
  ],
};
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="max-w-medium text-lg md:text-xl text-slate-300 mb-12 leading-relaxed font-medium">
              Join a community of forward-thinkers. Our inclusive admission
              policy ensures that ambition and the drive to succeed are the only
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-slate-800 leading-relaxed font-medium mb-12">
                ...
                individuals ready to upgrade their skills, grow their
                businesses, or advance their careers.
              </p>
              ...
              <div className="bg-slate-50 p-8 border-l-4 border-primary">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-black text-slate-950 uppercase text-sm tracking-widest mb-2">
                      No Prior Degree Required
                    </h4>
                    <p className="text-slate-600 font-medium">
                      Our professional certificate and diploma programmes are
                      designed for entrepreneurs and professionals ready to
                      upgrade their skills without barriers.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="p-8 border border-slate-100 hover:border-primary/40 transition-all hover:bg-primary/[0.02] hover:shadow-xl hover:shadow-slate-200/50 group"
                >
                  <item.icon className="w-8 h-8 text-primary mb-6 group-hover:scale-110 transition-transform" />
                  <h4 className="font-black uppercase text-xs tracking-widest text-slate-950 mb-4">
                    {item.title}
                  </h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              <div>
                ...
                <p className="text-slate-700 font-medium mb-12 leading-relaxed">
                  Enrollment in any of our professional diploma programs
                  requires a standard fee of{" "}
                  <span className="text-primary font-black">N 500,000</span>.
                  Fees allow for full access to curriculum materials, both
                ...
                <div className="space-y-6">
                  <div className="flex gap-6 p-8 bg-slate-950 text-white group hover:bg-blue-600 transition-colors">
                    ...
                    <div>
                      <h4 className="font-black uppercase text-[10px] tracking-widest mb-2 opacity-60">
                        Admission Enquiries
                      </h4>
                  ...
                  <div className="flex gap-6 p-8 bg-slate-50 border border-slate-100 group">
                    ...
                    <div>
                      <h4 className="font-black uppercase text-[10px] tracking-widest mb-2 text-slate-500">
                        Official Email
                      </h4>
              ...
              <div className="space-y-6">
                <div className="p-8 border-2 border-slate-100 relative overflow-hidden group hover:border-primary transition-all">
                  ...
                  <h4 className="text-2xl font-black text-slate-950 mb-8 uppercase italic font-serif">
                    Zenith Bank
                  </h4>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between border-b border-slate-100 pb-2">
                      ...
                      <span className="text-xs font-black text-slate-950 uppercase">
                        Federal Secretariate, Rivers State
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest text-center mt-8">
                  Kindly present your payment teller or electronic evidence at
      ...
      <section className="py-24 bg-slate-950 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-slate-400 font-medium mb-12 max-w-2xl mx-auto">
            Take the first step towards a globally recognized professional
            qualification today.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Button
              size="lg"
              className="nbu-gradient text-white px-10 h-16 text-sm font-bold uppercase tracking-widest rounded-none group"
            >
              Apply Now
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white/20 text-white hover:bg-primary hover:border-primary hover:text-white px-10 h-16 text-sm font-bold uppercase tracking-widest rounded-none"
            >
              Download Handbook
            </Button>
          </div>
