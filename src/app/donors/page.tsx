...
const IMPACT_AREAS = [
  {
    ...
    description:
      "Ensure that the brightest minds have access to world-class business education regardless of their financial background. Your support creates leaders.",
  },
  {
    icon: Globe,
    title: "Global Research Initiatives",
    description:
      "Fund groundbreaking research that addresses complex business challenges in emerging markets and contributes to sustainable global economic development.",
  },
  {
    icon: Building2,
    title: "Campus Infrastructure",
    description:
      "Help us build state-of-the-art learning environments, digital innovation labs, and modern facilities that enhance the educational experience.",
  },
  {
    icon: HeartHandshake,
    title: "Endowed Chairs",
    description:
      "Attract and retain world-renowned faculty by supporting endowed professorships, ensuring top-tier academic mentorship for our students.",
  },
];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-2xl text-slate-300 leading-relaxed font-light max-w-2xl border-l border-white/10 pl-8 mb-12">
              Your philanthropic partnership drives innovation, empowers
              exceptional students, and elevates our standard of academic
              excellence.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="space-y-6 text-slate-700 text-lg leading-relaxed font-medium mb-10">
                <p>
                  At Nigerian British University Business School, we believe
                  that education is the most powerful catalyst for economic and
                  social transformation. By choosing to invest in our
                  institution, you are directly shaping the future of business
                  leadership in Africa and beyond.
                </p>
                <p>
                  Our donors and partners form the bedrock of our strategic
                  growth. Through your generous support, we can expand our
                  reach, enhance our technological infrastructure, and ensure
                  that financial constraints never deter brilliance.
                </p>
              </div>
              ...
              <div className="bg-slate-50 border-l-4 border-primary p-8">
                ...
                <p className="text-sm text-slate-600 font-medium">
                  We maintain the highest standards of financial stewardship,
                  ensuring that every contribution is maximized to achieve its
                  intended impact.
                </p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-lg text-slate-300">
              Direct your philanthropy toward the initiatives that align closest
              with your personal or corporate values.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {IMPACT_AREAS.map((area, i) => (
              <div
                key={i}
                className="group p-10 border border-white/10 hover:border-primary/50 bg-white/5 hover:bg-white/10 transition-all duration-300"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-white border border-slate-100 shadow-2xl p-12 md:p-20 text-center">
            ...
            <p className="text-lg text-slate-700 mb-12 font-medium max-w-2xl mx-auto">
              We welcome strategic alliances with industry leaders. Partnering
              with NBU Business School provides organizations with access to
              cutting-edge research, custom executive education, and a pipeline
